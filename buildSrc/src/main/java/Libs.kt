object Libs {
    ...
    const val VIEWPAGER2 = "androidx.viewpager2:viewpager2:${Versions.VIEW_PAGER}"
    ...
    const val COROUTINE_TEST = "org.jetbrains.kotlinx:kotlinx-coroutines-test:${Versions.KOTLIN}"
    const val ADAPTER_DELEGATE =
        "com.hannesdorfmann:adapterdelegates4-kotlin-dsl:${Versions.ADAPTER_DELEGATES}"
    const val ADAPTER_DELEGATE_VB =
        "com.hannesdorfmann:adapterdelegates4-kotlin-dsl-viewbinding:${Versions.ADAPTER_DELEGATES}"
    const val PAGING = "androidx.paging:paging-runtime:${Versions.PAGING}"
    const val ADAPTER_DELEGATES_PAGING =
        "com.hannesdorfmann:adapterdelegates4-pagination:${Versions.ADAPTER_DELEGATES}"
