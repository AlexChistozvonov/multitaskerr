...
import com.aldera.multitasker.presentation.launch.LaunchFragmentDirections
...
class RegistrationFragment: Fragment(R.layout.registration_fragment) {
    ...
    private fun initView() = with(binding) {
        tvHaveRegister.setOnClickListener{ findNavController().navigate(RegistrationFragmentDirections.openLoginFragment()) }
...
//                binding.etEmail.error = "Неправильные данные"
            }
        }
    }
}